...
def filter_emails(email):
    ...
    unwanted_patterns = [
        r'support', r'service', r'example', r'info', r'noreply',
        r'admin', r'contact', r'help', r'feedback', r'sales', r'press',r'complaints',r'mailer',r'payment',r'collection',r'helpdesk',r'john',r'unsubscribe'
    ]
